...
## 再現
React Spectrumを使用したGatsbyサイトの[example](https://github.com/devongovett/rsp-gatsby)をcloneして yarn build && serve  
こんな感じです。
...
`prefers-color-scheme`クエリでOSのカラーモード設定に従うのは良いプラクティスだと思うのですが、SSRとはトレードオフなんですかね?
