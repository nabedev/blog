...
type ProductIndexQuery = { readonly allProductsYaml: { readonly nodes: ReadonlyArray<Pick<ProductsYaml, 'name' | 'repository' | 'description' | 'id' | 'demo' | 'type' | 'tags'>> } };
